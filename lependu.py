...
def lettre_dans_mot(lettre):
    ...
    if partie_en_cours:
        ...
        if not lettre_dans_mot:        # Lettre eronnée. Changement image.
            ...
            # Les lettres n'ont pas été trouvées. Pendaison.
            if nb_echecs == 10:
...
while voir_regles_jeu:
    ...
    for event in pygame.event.get():
        ...
        # Touche voir règles = "F2".
            ...
            image_regles = pygame.image.load(
                "Images/Regles_pendu.jpg").convert()
        ...
        # Touche suite = "Espace".
            ...
            tableau_honneur = pygame.image.load(
                "Images/Tableau_honneur.jpg").convert()
...
def nom_du_champion():
    ...
    police = pygame.font.Font("Font/PlayBill.ttf", 52,
    ...
    # Ici le texte "Noir" est centré
    textRect.centerx = fenetre.get_rect().centerx - 336
    # sur la fenêtre "Le champion".
    textRect.y = 135
    fenetre.blit(text, textRect)
    ...
    # Ici le texte "Rouge" est centré
    textRect.centerx = fenetre.get_rect().centerx - 338
    # sur la fenêtre "Le champion".
    textRect.y = 132
    fenetre.blit(text, textRect)
...
def afficher_mot():
    ...
    while i < len(mot):
        ...
        police = pygame.font.Font(
            "Font/JesterRES.ttf", 30, bold=False, italic=False)
